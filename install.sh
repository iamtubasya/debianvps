...
echo -e "${YELLOW}           Powered By ChiperFlux${RESET}"
...
############################
# INSTALL DEBIAN (STYLE LIKE UBUNTU FUNCTION)
############################
install_debian() {

DEBIAN_URL="https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-${ARCH_ALT}/bookworm/rootfs.tar.xz"
...
############################
# CONFIGURE SYSTEM (LIKE UBUNTU STYLE)
############################
configure_system() {
...
############################
# MAIN EXECUTION (SAME STYLE AS UBUNTU SCRIPT)
############################
show_logo
install_dependencies
